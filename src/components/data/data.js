// ข้อมูล Data ที่สร้างขึ้นมาเอง เหมือนกับดึง API เพื่อนำไปใช้ ปกติจะใช้ Axios ดึงข้อมูลทั้งหมดเพื่อเข้ามาใช้

// Object in Array ,ตัวแปร data มี Object 16 ตัว , catagory มี object 8 ตัว ใช้สำหรับเป็นข้อมูลอาหาร เวลาเรา Search ค้นหา อาหาร
export const data = [  
    {
      id: 1,
